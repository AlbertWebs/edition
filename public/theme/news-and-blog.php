					...
					<div class="container">
						<div class="left-header">
							<ul class="navi-level-1">
								<li><a href="index.php" class="logo"><img src="images/Header/logo.png" class="img-responsive" alt="High Res Logo"></a></li>
							</ul>
						</div><!-- End Left Header -->
						<nav>
                ...
                <section>
					<div class="sub-header-breadcrumbs sub-header-1-breadcrumbs sub-header-contact-breadcrumbs fake-position">
						<div class="sub-header-content-breadcrumbs">
							<h2 class="text-cap white-text">News & Blogs</h2>
							<ol class="breadcrumb breadcrumb-arc text-cap">
								<li>
									<a href="#">Home</a>
								</li>
								<li class="active">News & Blogs</li>
							</ol>
						</div>
					</div>
				</section>
										...
										<div class="row">
											<div class="blog-warp blog-grid-3-col clearfix">
												<div class="clearfix blogContainer blog-grid-3-col-container">
														...
														<div class="element-item  interior wow fadeInLeft" data-wow-delay=".25s">
																...
																<article>
																	...
																	<div class="latest-blog-post-description">
																		...
																		<p>Colors are meant to tell a story of warmth and layering that can be dificult to achieve otherwise.Rooms that make you feel calm and opulent often time incorporate wooden element that set vibe. Tell your story today..</p>
																		
																	</div>
															</article>
														</div>
													
														<div class="element-item  interior wow fadeInLeft" data-wow-delay=".35s">
															<article>
																<figure class="latest-blog-post-img">
																	<a href="blogDetail.html">
																...
																<div class="latest-blog-post-description">
																	...
																	<p>Trendy interiors are meant to tell a story of warmth and layering that can be difficult to achieve otherwise. Rooms that make you feel calm and opulent often tome incorporate wooden element that sets the.....</p>
																	
																</div>
														    </article>
													    </div>

                                                        <div class="element-item  interior wow fadeInLeft" data-wow-delay=".45s">
                                                            ...
                                                            <article>
                                                                ...
                                                                <div class="latest-blog-post-description">
                                                                    ...
                                                                    <p>Wardobes are meant to tell a story of warmth and layering that can be difficult to achieve otherwise. Rooms that make you feel calm and opulent often tome incorporate wooden element that sets the.....</p>
                                                                    
                                                                </div>
                                                            </article>
                                                        </div>

                                                        <div class="element-item  interior wow fadeInLeft" data-wow-delay=".55s">
                                                        ...
                                                        <div class="element-item  interior wow fadeInLeft" data-wow-delay=".65s">
                                                        ...
                                                        <div class="element-item  interior wow fadeInLeft" data-wow-delay=".75s">
