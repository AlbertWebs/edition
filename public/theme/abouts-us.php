...
<head>
		...
		<link rel="stylesheet" href="switcher/colors/yellow.css" type="text/css" id="colors">   
		  ...
		  <!-- <link rel="stylesheet" href="headline/css/reset.css">  -->
			<link rel="stylesheet" href="headline/css/style.css">
			<script src="headline/js/modernizr.js"></script>
	        		...
	        		<div class="header-mobile-menu">
	          		...
	          		<div class="mCustomScrollbar light" data-mcs-theme="minimal-dark">
	                    ...
	                    <ul>
							...
							<li class="has-sub"><a href="about-us.php"><span>About Us</span></a>
								  
							</li>
							<li class="has-sub"><a href="services.php"><span>Services</span></a>
							   
							</li>
							<li><a href="portfolio.php"><span>Projects</span></a>
								<ul>
							...
							<li ><a href="blog.php"><span>News & Blog</span></a>
					...
					<div class="container">
						<div class="left-header">
							<ul class="navi-level-1">
								<li><a href="index.php" class="logo"><img src="images/Header/logo.pnga" class="img-responsive" alt="High Res Logo"></a></li>
							</ul>
						</div><!-- End Left Header -->
						<nav>
							<ul id="main-navi" class="navi-level-1 hover-style-2 main-navi">
		                        <li class="has-sub"><a href="index.php"><span class="active">Home</span></a>
		                           
		                        </li>
		                        <li class="has-sub"><a href="about-us.php"><span style="color:#f15825">About Us</span></a>
		                              
		                        </li>
		                        <li class="has-sub"><a href="services.php"><span>Services</span></a>
		                           
		                        </li>
		                       	<li class="has-sub"><a href="portfolio.php"><span>Portfolio </span></a>
		                       	
		                       	</li>
		                        
		                        <li class="has-sub"><a href="blog.php"><span>News & Blog</span></a>
		                             
                                </li>
                                
                            
		                     	
		                        <li class="has-sub"><a href="contact-us.php"><span>Contact Us</span></a>
			...
			<!-- Page Content -->
                ...
                <div class="container">
                    <div class="service-wrap">
                        <div class="col-md-4 col-sm-6 col-lg-4" style="padding-bottom:100px;">

                            <div class="service__item-1 service__intro" style="background-image: url('img/service-01.jpg');">
                                <div class="service__item-inner">
                                    ...
                                    <div>
                                    <a href="about-us.html" class="au-btn au-btn--big au-btn--pill au-btn--white au-btn--border au-btn--big">Read More</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4" style="padding-top:100px;">
                            ...
                            <div class="overlay-container">
                                <img class="about-img" src="img/foto-pattern-desert-oak-swing06.jpg" alt="#">
                            ...
                            <div class="about-btn-container">
                               <center><a href="about-us.html" class="au-btn-2 au-btn--big au-btn--pill au-btn--white au-btn--border au-btn--big">Read More</a></center>
                            </div>
                            <!--  -->
						...
						<div class="col-md-4 col-sm-6 col-lg-4" style="padding-top:100px;">
							...
							<!--  -->
							<div class="overlay-container">
								<img class="about-img" src="img/rustic-front-door-with-tiny-panes.jpg" alt="#">
								<div class="content-container">
									<div class="room-checks-1">
									<h4 class="">Our Mision</h4>
									</div>
						...
						<div class="row">
							<div class="about-intro">
								<div class="about-intro-img">
									<img src="images/About/1.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="about-intro-text">
									<h2 class="text-cap">About Us</h2>
									<p>Old education him departure any arranging one prevailed. Their end whole might began her. Behaved the comfort another fifteen eat. Partiality had his themselves ask pianoforte increasing discovered.</p>
									<p><strong>Small change, big difference.</strong> Another Dummy text goes here, here and There and there, and There.</p>
									<p><strong>Ideas & Creative.</strong> Old education him departure any arranging one prevailed. Their end whole might began her. Behaved the comfort another fifteen eat. Partiality had his themselves ask pianoforte increasing discovered. So mr delay at since place whole above miles. He to observe conduct at detract because. Way ham unwilling not breakfast furniture explained perpetual. </p>
									<div class="clearfix mgb20"></div>
									<h3 class="text-cap">Some Sub Heading</h3>
									<p>Old education him departure any arranging one prevailed. Their end whole might began her. Behaved the comfort another fifteen eat. Partiality had his themselves ask pianoforte increasing discovered. So mr delay at since place whole above miles. He to observe conduct at detract because.  </p>
					              ...
					              <div class="customNavigation">
			              		  ...
			              		  <div id="owl-team-3-columns" class="owl-carousel owl-theme clearfix">
						              <div class="item">
						              	<div class="item-team">
						              		<div class="portrait-member">
							                  	<img src="#" class="img-responsive" alt="Team Image One">
						                  	</div>
						                  	<div class="member-info text-center hvr-float-shadow">
							                  	<h5 class="text-cap">Ronald Matelong</h5>
						              ...
						              <div class="item">
						              	<div class="item-team">
							                  <div class="portrait-member">
												<img src="#" class="img-responsive" alt="Team Image Two">
							                  </div>
							                  <div class="member-info text-center hvr-float-shadow">
							                  	<h5 class="text-cap">Noel Lawrence</h5>
						              ...
						              <div class="item">
						              	<div class="item-team">
							                  ...
							                  <div class="member-info text-center hvr-float-shadow">
							                  	<h5 class="text-cap">Henry Njoroge</h5>
						              ...
						              <div class="item">
						              	<div class="item-team">
							                  <div class="portrait-member">
												<img src="#" class="img-responsive" alt="Team Image Three">
							                  </div>
							                  <div class="member-info text-center hvr-float-shadow">
							                  	<h5 class="text-cap">Melanie Cortez</h5>
						              ...
						              <div class="item">
						              	<div class="item-team">
							                  <div class="portrait-member">
												<img src="#" class="img-responsive" alt="Team Image Four">
							                  </div>
							                  <div class="member-info text-center hvr-float-shadow">
							                  	<h5 class="text-cap">Jackson Mugaru</h5>
	...
	<script src="headline/js/main.js"></script> <!-- Resource jQuery -->
	</body>
