...
<head>
	...
	<body>
	        		...
	        		<div class="header-mobile-menu">
	          		...
	          		<div class="mCustomScrollbar light" data-mcs-theme="minimal-dark">
	                    ...
	                    <ul>
							...
							<li><a href="contact-us.php"><span style="color:#f15825">Contact Us</span></a>
	    ...
	    <div id="page">
					...
					<div class="container">
						...
						<nav>
							<ul id="main-navi" class="navi-level-1 hover-style-2 main-navi">
		                        ...
		                        <li class="has-sub"><a href="contact-us.php"><span style="color:#f15825">Contact Us</span></a>
			...
			<!-- End Section -->
			<section class="paddingss no-padding-bot">
