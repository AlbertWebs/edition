	        		...
	        		<div class="header-mobile-menu">
	          		...
	          		<div class="mCustomScrollbar light" data-mcs-theme="minimal-dark">
	                    ...
	                    <ul>
							...
							<li ><a href="index.php#blog"><span>News</span></a>
					...
					<div class="container">
						<div class="left-header">
							<ul class="navi-level-1">
								<li><a href="index.php" class="logo"><img src="images/Header/logo.png" class="img-responsive" alt="Image"></a></li>
							</ul>
						</div><!-- End Left Header -->
						<nav>
							<ul id="main-navi" class="navi-level-1 hover-style-2 main-navi">
		                        ...
		                        <li class="has-sub"><a href="services.php"><span>Services</span></a>
		                       	...
		                       	<li class="has-sub"><a href="portfolio.php"><span style="color:#f15825">Portfolio </span></a>
		                       	
		                       	</li>
		                        
		                        <li class="has-sub"><a href="blog.php"><span>News</span></a>
						...
						<!-- <div class="container"> -->
							<div class="clearfix projectContainer portfolio-grid-3-container">
									...
									<div class="element-item  Residential">
											...
											<div class="project-info">
												<a href="portfolioDetail.html"><h4 class="title-project text-cap text-cap">Modern Design</h4></a>
												<a href="portfolioDetail.html" class="cateProject">Resident</a>
											</div>
									</div>
									...
									<div class="element-item Residential ">
											...
											<div class="project-info">
											<a href="portfolioDetail.html"><h4 class="title-project text-cap">Dream house</h4></a>
												<a href="portfolioDetail.html" class="cateProject">Residential</a>
										</div>
									</div>    
									...
									<div class="element-item Ecommercial">
											...
											<a class="portfolio-img-demo" href="portfolioDetail_1.html"><img src="images/Project/11.jpg" class="img-responsive" alt="Image"></a>
											
											<div class="project-info">
											<a href="portfolioDetail.html"><h4 class="title-project text-cap">Living Room Art</h4></a>
											<a href="portfolioDetail.html" class="cateProject">Residential</a>
											</div>
									</div>
									...
									<div class="element-item Ecommercial ">
											...
											<div class="project-info">
											<a href="portfolioDetail.html"><h4 class="title-project text-cap">Bedroom Design Awward</h4></a>
												<a href="portfolioDetail.html" class="cateProject">Residential</a>
											</div>
									</div>
