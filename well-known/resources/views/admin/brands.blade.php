                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            @foreach($Client as $value)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><a onclick="return confirm('Do you want to delete this Client?')" href="{{url('/admin')}}/deleteBrand/{{$value->id}}"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <input style="width:100%" type="url" value="{{url('/classifieds')}}/brand/{{$value->name}}">
                                        </div>
