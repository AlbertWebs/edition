                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                ...
                                <button  type="button" onclick="" class="btn btn-block btn-warning" data-toggle="modal"  data-target="#newReg3"> Merchant To Merchant(B2B) </button>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-danger">
                                <div class="panel-body">
                                    ...
                                    <button onclick="window.open('{{url('/admin/lnmo')}}','_self')"  type="button" onclick="" class="btn btn-block btn-default">Online Payments(<?php $MPESAA = DB::table('lnmo_api_response')->get(); echo count($MPESAA) ?>) </button>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <button  type="button" onclick="window.open('{{url('/admin/b2b')}}','_self')" class="btn btn-block btn-warning" > B2B(<?php $MPESAA = DB::table('b2b_api_response')->get(); echo count($MPESAA) ?>) </button>
