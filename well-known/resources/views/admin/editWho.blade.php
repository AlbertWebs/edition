              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/dashboard/edit_why')}}/{{$Action->id}}" enctype="multipart/form-data">
                   
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="{{$Action->title}}" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/why/{{$Action->image}}" alt="" /></div>
