              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/dashboard/savesitesettings')}}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="logo_honey_cheat" value="{{$value->logo_honey}}">
                    <input type="hidden" name="logo_meat_cheat" value="{{$value->logo_meat}}">
