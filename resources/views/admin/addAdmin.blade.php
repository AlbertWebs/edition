...
<div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <center><h2> Add Administrator & Team Member </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="position" value="" placeholder="e.g COO " class="form-control" />
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="" name="facebook" type="url" placeholder="e.g https://www.facebook.com/designekta" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="" name="twitter" type="url" placeholder="e.g https://www.twitter.com/designekta" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="" name="linkedin" type="url" placeholder="e.g https://www.linkedin.com/designekt" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="" name="instagram" type="url" placeholder="e.g https://www.instagram.com/designekt" >
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">Admin/Team Image</label>
                        <div class="">
