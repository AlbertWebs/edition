               ...
               <center>
				...
				@endif
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="" placeholder="e.g Pawpaws " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="wholesale_price" value="" placeholder="" class="form-control" />
                        </div>
                    </div>
