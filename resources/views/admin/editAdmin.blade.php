              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/dashboard/edit_Admin')}}/{{$Admin->id}}" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" readonly id="text1"  name="email" value="{{$Admin->email}}" placeholder="e.g juliekoi2@gmail.com " class="form-control" />
