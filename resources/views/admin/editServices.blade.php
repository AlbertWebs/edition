				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="label" value="{{$Services->label}}" placeholder="e.g Web Development " class="form-control" />
                        </div>
                    </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/services/{{$Services->thumb}}" alt="" /></div>
