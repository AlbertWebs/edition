               ...
               <center>
				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Wholesale Product Price</label>

                        <div class="col-lg-8">
                            <input type="text" name="wholesale_price" value="{{$Product->price_wholesale}}" placeholder="{{$Product->wholesale_price}}" class="form-control" />
                        </div>
                    </div>
                    ...
                    <!-- Brands -->
                    <?php
                            $ComboID = $Product->combo;
                            $TheCombo = DB::table('product')->where('id',$ComboID)->get();
                    ...
                    <div class="col-lg-8">
                        <select name="combo" data-placeholder="Choose Main Product" class="form-control chzn-select" tabindex="2">
                           <option selected="selected" value="{{$Product->combo}}">@foreach($TheCombo as $Thecombo){{$Thecombo->name}}@endforeach</option>
                    ...
                    <div class="make-switch" data-on="success" data-off="danger">
                                ...
                                ?>
                                <input name="wholesale" type="checkbox" {{$stockValue}} />
                            </div>
                    </div>
                    </div>
                    <!-- </Stock Control -->
                    ...
                    <div class="form-group col-lg-4">
                        <label class="control-label">Image One(270by270)</label>
                        <div class="">
                    ...
                    <div class="form-group col-lg-4">
                        <label class="control-label">W-780 H-480()</label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                    ...
                    <div class="form-group col-lg-4">
                        <label class="control-label">Image Three(270 by 270)</label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
