                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php $__currentLoopData = $Services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><img with="100" height="100" src="<?php echo e(url('/')); ?>/uploads/services/<?php echo e($value->image_one); ?>"></td>
                                                    <td class="center"><a href="<?php echo e(url('/dashboard')); ?>/editServices/<?php echo e($value->id); ?>"   class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a></td>
                                                    <td class="center"><a onclick="return confirm('Do you want to delete this Service?')" href="<?php echo e(url('/dashboard')); ?>/deleteService/<?php echo e($value->id); ?>"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a></td>
