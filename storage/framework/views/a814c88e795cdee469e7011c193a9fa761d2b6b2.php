              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/dashboard/edit_Admin')); ?>/<?php echo e($Admin->id); ?>" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" readonly id="text1"  name="email" value="<?php echo e($Admin->email); ?>" placeholder="e.g juliekoi2@gmail.com " class="form-control" />
