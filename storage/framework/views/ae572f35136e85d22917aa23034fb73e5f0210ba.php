                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php $__currentLoopData = $Admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <?php else: ?>
                                                    <td class="center"><a onclick="return confirm('Delete This Admin?')" href="<?php echo e(url('/dashboard')); ?>/deleteAdmin/<?php echo e($value->id); ?>"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a> <br><br><a href="<?php echo e(url('/dashboard')); ?>/editAdmin/<?php echo e($value->id); ?>"   class="btn btn-success"><i class="icon-pencil icon-white"></i> Edit</a></td>
                                                    <?php endif; ?>
                                                </tr>
