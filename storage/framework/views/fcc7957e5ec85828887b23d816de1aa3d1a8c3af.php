...
<!--  -->
            <section>
               <div class="rev_slider_wrapper" style=" background:linear-gradient(rgba(6, 43, 49, 0.45),rgba(6, 43, 49, 0.65)),url('<?php echo e(url('/')); ?>/uploads/pages/<?php echo e($page->page_featured_image_four); ?>');background-position: center top; background-size: cover; background-repeat: no-repeat;">
