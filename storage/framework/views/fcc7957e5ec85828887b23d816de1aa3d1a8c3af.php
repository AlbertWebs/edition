...
<!--================Our Team Area =================-->
		...
		<!-- Contact Form Section -->
			...
			<section style="min-height:650px; background:linear-gradient(rgba(6, 43, 49, 0.75),rgba(6, 43, 49, 0.75)),url('<?php echo e(url('/')); ?>/uploads/banner/20210715164329_IMG_3200-min.jpg');background-position: center bottom; background-size: contain, cover; ;background-repeat: no-repeat;">
                <div class="container">
