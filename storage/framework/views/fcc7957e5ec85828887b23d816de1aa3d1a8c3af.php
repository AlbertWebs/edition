...
<!--  -->
            <section>
               <div class="rev_slider_wrapper" style=" background:linear-gradient(rgba(6, 43, 49, 0.45),rgba(6, 43, 49, 0.45)),url('<?php echo e(url('/')); ?>/uploads/pages/<?php echo e($page->page_featured_image_four); ?>');background-position: center center; background-size: cover; background-repeat: no-repeat;">
                  ...
                  <div id="slider-h3" class="rev_slider slider-home-3" data-version="5.0">
                     <ul>
                        ...
                        <li data-transition="slideup" data-masterspeed="1000" >
                           <!-- MAIN IMAGE -->
                           <!-- <img class="tint-about" src="<?php echo e(url('/')); ?>/uploads/pages/<?php echo e($page->page_featured_image_four); ?>"  alt="" data-bgposition="center center">							 -->
...
<!--  -->
						...
						<div class="row">
							<div class="about-intro">
								<div class="about-intro-img wow fadeInLeft" data-wow-delay=".55s">
									<img style="max-height:400px; width:100%;" src="<?php echo e(url('/uploads/pages')); ?>/<?php echo e($page->page_featured_image_one); ?>" class="img-responsive" alt="Image">
								</div>
								...
								<div class="">
									...
									<p class="about-text"><?php echo html_entity_decode($about->content); ?></p>
	...
	<!--  -->
	<!-- Container -->
	<div class="row" style="min-height:550px; background:linear-gradient(rgba(6, 43, 49, 0.65),rgba(6, 43, 49, 0.65)),url('<?php echo e(url('/')); ?>/uploads/pages/<?php echo e($page->page_featured_image_three); ?>');background-position: center top; background-size: contain, cover; ;background-repeat: no-repeat;">
			<!--  -->
			...
			<div class="col-md-4 values-section">
				<img src="<?php echo e(url('/')); ?>/uploads/values/<?php echo e($coreValue->icon); ?>" alt="Core Values">
				<h3 class="headline text-center"> <?php echo e($coreValue->title); ?> </h3>
				<p class="value-text text-center"><?php echo e($coreValue->content); ?>
...
<!--================Our Team Area =================-->
		...
		<!-- Contact Form Section -->
			...
			<section style="min-height:650px; background:linear-gradient(rgba(6, 43, 49, 0.75),rgba(6, 43, 49, 0.75)),url('<?php echo e(url('/')); ?>/uploads/pages/<?php echo e($page->page_featured_image_two); ?>');background-position: center center; background-size: contain, cover; ;background-repeat: no-repeat;">
                <div class="container">
