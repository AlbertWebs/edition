              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/dashboard/savesitesettings')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" name="url" value="<?php echo e($value->url); ?>" type="text" placeholder=",g https://www.designekta.com" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="<?php echo e($value->till); ?>" name="till" type="text" placeholder="e.g 942527" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" value="<?php echo e($value->instagram); ?>" name="instagram" type="url" placeholder="e.g https://www.instagram.com/designekt" >
                    ...
                    <input type="hidden" name="logo_honey_cheat" value="<?php echo e($value->logo_honey); ?>">
                    <input type="hidden" name="logo_meat_cheat" value="<?php echo e($value->logo_meat); ?>">
